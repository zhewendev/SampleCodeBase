...
(function() {
    console.log("WebViewJsBridge start111");
    if (window.WebViewJavascriptBridge) {
        return;
    }
    console.log("WebViewJsBridge start222");
    ...
    function send(data, responseCallback) {
        console.log("WebViewJsBridge send");
...
//        return;
//    }
//    console.log("WebViewJsBridge start");
//
//    var messagingIframe;
...
//
//    var CUSTOM_PROTOCOL_SCHEME = 'jsBridge';  // 消息的 scheme
...
//        console.log("WebViewJsBridge _doSend");
//        if (responseCallback) {
